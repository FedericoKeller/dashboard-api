...
<mj-body background-color="#ffffff" font-size="13px">
  ...
  <mj-section background-color="hsl(235, 46%, 20%)" padding-bottom="20px" padding-top="20px">
    <mj-column vertical-align="middle" width="100%">
      ...
      <mj-button align="left" font-size="22px"background-color="hsl(246, 80%, 60%)" border-radius="10px" color="#fff" font-family="open Sans Helvetica, Arial, sans-serif" href=${process.env.NODE_ENV === 'production' ? `https://dashsmart-api.herokuapp.com/register/${token}` : `http://localhost:4200/register/${token}`}>Activate Account</mj-button>
      ...
      <mj-section>
        <mj-column>
          ...
          Your DashSmart password can be reset by clicking the button below. If you did not request a new password, please ignore this email.
                ...
                <mj-button align="center" padding-bottom="20px" padding-top="20px" font-size="22px"background-color="#00A390" border-radius="10px" color="#fff" font-family="open Sans Helvetica, Arial, sans-serif" href=${process.env.NODE_ENV === 'production' ? `https://dashsmart-api.herokuapp.com/reset/${token}` : `http://localhost:4200/reset/${token}`}>Reset Password</mj-button>
